...
botao_pesquisa = driver\
    .find_element("xpath", "//button[@aria-label='Submit' and @value='search']")
...
link_extrato = driver.\
    find_element(By.CSS_SELECTOR, "a.heading[title='Extratos de Fundos de Investimento (2024)']")
